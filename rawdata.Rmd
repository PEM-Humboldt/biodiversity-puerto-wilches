...
A<-read_xlsx(file.path(fol_data,"Mamiferos","I2D-BIO_2021_083_v2.xlsx"),sheet="Registros",col_types = types)
dataGrupos$Mamiferos$registros$eventTime[!is.na(A)]<-as.character(format(A[!is.na(A)],"%H:%M:%S"))


dataGrupos$Mamiferos_us$event <- read.xlsx(file.path(fol_data,"Mamiferos","I2D-BIO_2021_094_v3.xlsx"),sheet="Eventos")
dataGrupos$Mamiferos_us$registros <- read.xlsx(file.path(fol_data,"Mamiferos","I2D-BIO_2021_094_v3.xlsx"),sheet="Registros")
#forTime <- read_xlsx(file.path(fol_data,"Mamiferos","I2D-BIO_2021_094_v3.xlsx"),sheet = "Registros")
#dataGrupos$Mamiferos_us$registros$eventTime <- as.character(format(forTime$eventTime,"%H:%M:%S"))
