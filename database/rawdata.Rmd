...
dataGrupos$Collembolos$fotos <- read.xlsx(file.path(fol_data,"Collembolos","I2D-BIO_2021_099_v3.xlsx"),sheet="Imagenes-Collembola")
...
dataGrupos$Cameras_trampa$event <- read.xlsx(file.path(fol_data,'..','ExtraData',"DwC camaras ANH_13octubre2022_DMM.xlsx"), sheet = "Eventos")
dataGrupos$Cameras_trampa$registros <- read.xlsx(file.path(fol_data,'..','ExtraData',"DwC camaras ANH_13octubre2022_DMM.xlsx"), sheet = "Registros")
...
A<-read_xlsx(file.path(fol_data,'..','ExtraData',"DwC camaras ANH_13octubre2022_DMM.xlsx"),sheet="Registros",col_types = types)
