...
```{r}
file <- "../Data_Documents/ExtraData/HerpetosCorreciones.xlsx"
corr <- read.xlsx(file)
...
```{r}
file <- "../Data_Documents/ExtraData/EscarabajosCambio.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
...
```{r}
file <- "../Data_Documents/ExtraData/CollembolaCambio.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
...
```{r}
file <- "../Data_Documents/ExtraData/HormigasCambiar.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
...
```{r}
file <- "../Data_Documents/ExtraData/MamiferosCambiar.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
...
```{r}
file <- "../Data_Documents/ExtraData/Mariposas2023.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
...
```{r}
file <- "../Data_Documents/ExtraData/Coordenada Aves.xlsx"
corr <- read.xlsx(file)
colnames(corr) <- gsub("[().-]","_",tolower(gsub("([a-z])([A-Z]+)","\\1_\\L\\2",colnames(corr),perl = T)))
