...
Las modificaciones que hay que hacer para Trebouxiophyceae es lo siguiente:
...
Los calculos para buscar elementos taxonomicos (en particular en operaciones JOIN) pueden tomar mucho tiempo de calculo, los INDEX siguientes permiten accelerar mucho el proceso!
...
En casos particulares, y eso solo hasta que la base de datos esté consolidada para todos los grupos, puede ser util tambien implementar los INDEX sobre la tabla taxonomy_total tambien:
```{sql, results='hide'}
