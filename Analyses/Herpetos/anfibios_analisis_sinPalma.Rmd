...
En este documento, sacamos los datos que corresponden a palma en el mapa de coberturas.
...
require(iNEXT)
require(ggplot2)
knitr::opts_chunk$set(cache=T,tidy.opts = list(width.cutoff = 70), tidy = TRUE, connection="fracking_db", max.print=50,fig.path="./Fig/anfibios_sinPal_",echo=T)
...
save_in_excel("anfibios_dataRangoAbundancia_sinPal.xlsx",rango_abundancia)
```
