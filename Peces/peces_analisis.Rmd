...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Tipo de cuerpo de agua","eventos","Riqueza colectada","observado","estimado","observado","estimado","observado","estimado"),caption="Estimaciones de diversidad por tipo de cuerpo de agua (atarraya)")%>%
...
sqldf(
  ...
  kable(booktabs=T, longtable=T,caption = "Estimaciones de diversidad por unidad de muestreo (arrastre)")%>%
  add_header_above(c(" ", "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")
```
...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Tipo de cuerpo de agua","eventos","Riqueza colectada","observado","estimado","observado","estimado","observado","estimado"),caption="Estimaciones de diversidad por tipo de cuerpo de agua (arrastre)")%>%
  add_header_above(c(" "=3, "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")%>%
   ##column_spec(2:9,width="cm")%>%
  column_spec(1:9,width="1.6cm")
...
sqldf(
  ...
  kable(booktabs=T, longtable=T,caption = "Estimaciones de diversidad por unidad de muestreo (electropesca)")%>%
  add_header_above(c(" ", "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")
```
...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Tipo de cuerpo de agua","eventos","Riqueza colectada","observado","estimado","observado","estimado","observado","estimado"),caption="Estimaciones de diversidad por tipo de cuerpo de agua (electropesca)")%>%
  add_header_above(c(" "=3, "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")%>%
   ##column_spec(2:9,width="cm")%>%
  column_spec(1:9,width="1.6cm")
...
sqldf(
  ...
  kable(booktabs=T, longtable=T,caption = "Estimaciones de diversidad por unidad de muestreo (trasmallo)")%>%
  add_header_above(c(" ", "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")
```
...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Tipo de cuerpo de agua","eventos","Riqueza colectada","observado","estimado","observado","estimado","observado","estimado"),caption="Estimaciones de diversidad por tipo de cuerpo de agua (trasmallo)")%>%
  add_header_above(c(" "=3, "q0 (riqueza)" = 2, "q1 (Shannon)" = 2, "q2 (Simpson)"=2))%>%
  kable_styling(latex_options = "striped")%>%
   ##column_spec(2:9,width="cm")%>%
  column_spec(1:9,width="1.6cm")
...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Temporada","Tipo de cuerpo de agua","eventos","Riqueza colectada","observado","estimado"),caption="Estimaciones de diversidad por tipo de cuerpo de agua (todos artes de pesca) desde la matriz de incidencia")%>%
...
iNEXT_todo_zona <- iNEXT(apply(cbind(nbSU,mat_todo_zona),1,function(x)x[x>0]),datatype = "incidence_freq",endpoint = 250,q=0)
```
...
data.frame(
  ...
  kable(booktabs=T, longtable=T,col.names = c("Zona","eventos","Riqueza colectada","observado","estimado"),caption="Estimaciones de diversidad por zonas (todos artes de pesca) desde la matriz de incidencia")%>%
  collapse_rows(columns = 1, valign = "middle", latex_hline = "major")%>%
  add_header_above(c(" "=3, "q0 (riqueza)" = 2))
```
...
text(x=(1:nb_sp)+.2,y=par("usr")[3]-1,names(sum_incidencia),xpd=NA,srt=45,adj=1.1)
COL<-rainbow(4)
points(sum_atarraya,type="b",bg=COL[1],pch=21,lty=2)
points(sum_arrastre,type="b",bg=COL[2],pch=22,lty=2)
points(sum_electropesca,type="b",bg=COL[3],pch=23,lty=2)
points(sum_trasmallo,type="b",bg=COL[4],pch=24,lty=2)
legend("topright",pch=c(15,21:24),col="black",pt.bg=c(NA,COL),legend=c("total", "Atarraya","Arrastre","Electropesca","Trasmallo"),title="Arte de pesca",bty="n")
```
...
par(mar = c(10.1,6.1,1,4.1))
sum_incidencia <- sort(colSums(matrix_todo),decreasing = T)[1:nb_sp]
tipCuerpAg<-factor(info_todo$tipo_cuerp_agua[match(rownames(matrix_todo),table= info_todo$anh_tempo)],levels=colList$aquatic_habitats$habitat_spa)
sum_incidencias_tipCuerpAg <- Reduce(rbind,by(matrix_todo[,names(sum_incidencia)],tipCuerpAg,colSums))

plot(1:nb_sp,sum_incidencia,ylab="Suma de las incidencias", xlab=NA,ylim=c(0,max(sum_incidencia)*1.1),pch=15,bty="n",xaxt="n",las=2,type="b",lty=3)
axis(side=1,at=1:nb_sp,labels=FALSE,lwd.tick=-1, pos=0,outer=T)
text(x=(1:nb_sp)+.2,y=par("usr")[3]-1,names(sum_incidencia),xpd=NA,srt=45,adj=1.1)
for(i in 1:nrow(sum_incidencias_tipCuerpAg))
{
  points(sum_incidencias_tipCuerpAg[i,],type="b",col=colList$aquatic_habitats$color[i],bg=colList$aquatic_habitats$color[i],pch=21,lty=2)
}

legend("topright",pch=c(15,rep(21,4)),pt.bg=c(NA,colList$aquatic_habitats$color),col=c("black",colList$aquatic_habitats$color),legend=c("total", colList$aquatic_habitats$habitat_spa),title="Tipo de cuerpo de agua",bty="n")
```
...
par(mar = c(10.1,6.1,1,4.1))
sum_incidencia <- sort(colSums(matrix_todo),decreasing = T)[1:nb_sp]
zonas<-factor(info_todo$zone[match(rownames(matrix_todo),table= info_todo$anh_tempo)],levels=colList$zonas$platform)
sum_incidencias_zonas <- Reduce(rbind,by(matrix_todo[,names(sum_incidencia)],zonas,colSums))

plot(1:nb_sp,sum_incidencia,ylab="Suma de las incidencias", xlab=NA,ylim=c(0,max(sum_incidencia)*1.1),pch=15,bty="n",xaxt="n",las=2,type="b",lty=3)
axis(side=1,at=1:nb_sp,labels=FALSE,lwd.tick=-1, pos=0,outer=T)
text(x=(1:nb_sp)+.2,y=par("usr")[3]-1,names(sum_incidencia),xpd=NA,srt=45,adj=1.1)
for(i in 1:nrow(sum_incidencias_zonas))
{
  points(sum_incidencias_zonas[i,],type="b",col=colList$zonas$color[i],bg=colList$zonas$color[i],pch=colList$zonas$pch[i],lty=2)
}

legend("topright",pch=c(15,colList$zonas$pch),pt.bg=c(NA,colList$zonas$color),col=c("black",colList$zonas$color),legend=c("total", colList$zonas$platform),title="Zonas",bty="n")
```

## Por arte de pesca
### Atarraya

```{r rangoabundancia_atarraya, fig.height=5, fig.width=8, fig.cap="Grafica Rango-abundancia, recolectado por atarraya"}
nb_sp<-15
par(mar = c(10.1,6.5,1,4.1))
sum_abundancia <- sort(colSums(matrix_atarraya),decreasing = T)[1:nb_sp]
...
points(log10(colSums(matrix_atarraya[grep("T1",rownames(matrix_atarraya)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T1"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T1"],lty=2)
points(log10(colSums(matrix_atarraya[grep("T2",rownames(matrix_atarraya)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T2"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T2"],lty=2)
...
```{r rangoabundancia_arrastre, fig.height=5, fig.width=8, fig.cap="Grafica Rango-abundancia, recolectado por arrastre"}
nb_sp<-15
par(mar = c(10.1,6.9,1,4.1))
sum_abundancia <- sort(colSums(matrix_arrastre),decreasing = T)[1:nb_sp]
plot(1:nb_sp,log10(sum_abundancia),ylab="Abundancia total", xlab=NA,ylim=c(0,max(log10(sum_abundancia))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
axis(side=1,at=1:nb_sp,labels=FALSE,lwd.tick=-1, outer=T, pos=0)
ATX <- seq(0,2000,by=10)
ATX <- ATX[1:(min(which(ATX>sum_abundancia[1]))+1)]
#ATX <- ATX[(max(which(ATX<sum_abundancia[nb_sp]))-1):min(which(ATX>sum_abundancia[1]))+1]
ATX <- unique(ATX[c(1,which(ATX%%50==0),length(ATX))])
show <- ATX%%100==0
...
axis(side=2,at=c(0,log10(ATX)[2:length(ATX)]),labels=ifelse(show,ATX,NA),las=2)
text(x=(1:nb_sp)+.2,y=-.1,names(sum_abundancia),xpd=NA,srt=45,adj=1.1)
points(log10(colSums(matrix_arrastre[grep("T1",rownames(matrix_arrastre)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T1"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T1"],lty=2)
points(log10(colSums(matrix_arrastre[grep("T2",rownames(matrix_arrastre)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T2"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T2"],lty=2)
legend("topright",pch=c(15,colList$tempo$pch),col="black",pt.bg=c(NA,colList$tempo$color),legend=c("Ambas","Aguas altas","Aguas bajas"),title="Temporada",bty="n")
```

### Electropesca

```{r rangoabundancia_electropesca, fig.height=5, fig.width=8, fig.cap="Grafica Rango-abundancia, recolectado por electropesca"}
nb_sp<-15
par(mar = c(10.1,6.5,1,4.1))
sum_abundancia <- sort(colSums(matrix_electropesca),decreasing = T)[1:nb_sp]
plot(1:nb_sp,log10(sum_abundancia),ylab="Abundancia total", xlab=NA,ylim=c(0,max(log10(sum_abundancia))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
axis(side=1,at=1:nb_sp,labels=FALSE,lwd.tick=-1, outer=T, pos=0)
ATX <- seq(0,1000,by=10)
ATX <- ATX[1:(min(which(ATX>sum_abundancia[1]))+1)]
...
axis(side=2,at=c(0,log10(ATX)[2:length(ATX)]),labels=ifelse(show,ATX,NA),las=2)
text(x=(1:nb_sp)+.2,y=-.1,names(sum_abundancia),xpd=NA,srt=45,adj=1.1)
points(log10(colSums(matrix_electropesca[grep("T1",rownames(matrix_electropesca)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T1"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T1"],lty=2)
points(log10(colSums(matrix_electropesca[grep("T2",rownames(matrix_electropesca)),names(sum_abundancia)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T2"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T2"],lty=2)
legend("topright",pch=c(15,colList$tempo$pch),col="black",pt.bg=c(NA,colList$tempo$color),legend=c("Ambas","Aguas altas","Aguas bajas"),title="Temporada",bty="n")
```

### Trasmallo

No se pueden mostrar las temporadas, porque las abundancias son demasiado bajas

```{r rangoabundancia_trasmallo, fig.height=5, fig.width=8, fig.cap="Grafica Rango-abundancia, recolectado por trasmallo"}
nb_sp<-15
par(mar = c(10.1,6.5,1,4.1))
sum_abundancia <- sort(colSums(matrix_trasmallo),decreasing = T)[1:nb_sp]
plot(1:nb_sp,log10(sum_abundancia),ylab="Abundancia total", xlab=NA,ylim=c(0,max(log10(sum_abundancia))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
axis(side=1,at=1:nb_sp,labels=FALSE,lwd.tick=-1, outer=T, pos=0)
ATX <- seq(0,1000,by=5)
ATX <- ATX[1:(min(which(ATX>sum_abundancia[1]))+1)]
...
axis(side=2,at=c(0,log10(ATX)[2:length(ATX)]),labels=ifelse(show,ATX,NA),las=2)
text(x=(1:nb_sp)+.2,y=-.1,names(sum_abundancia),xpd=NA,srt=45,adj=1.1)
#points(log10(colSums(matrix_trasmallo[grep("T1",rownames(matrix_trasmallo)),names(sum_abundancia)])),type="b",pch=24,bg="grey",lty=2)
#points(log10(colSums(matrix_trasmallo[grep("T2",rownames(matrix_trasmallo)),names(sum_abundancia)])),type="b",pch=25,bg="grey",lty=2)
#legend("topright",pch=c(15,24,25),col="black",pt.bg="grey",legend=c("Ambas","Aguas altas","Aguas bajas"),title="Temporada",bty="n")
```
