...
La idea acá es aplicar todos los análisis soló sobre los datos de Pitfall, para ver si los análisis cambian en comparación con los análisis sobre la asociación entre berlese y pitfall...
...
require(iNEXT)
require(ggplot2)
knitr::opts_chunk$set(cache=T,tidy.opts = list(width.cutoff = 70), tidy = TRUE, connection="fracking_db", max.print=50,fig.path="./Fig/Pitfall_",echo=T)
...
infoTot<-import_cole$cole_info_sampling_pitfall
...
```{r cache=F}
cole_matrix <- import_cole$cole_pitfall_matrix
infoTot <- import_cole$cole_info_sampling_pitfall
