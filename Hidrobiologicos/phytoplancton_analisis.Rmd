...
mean_density <- sort(colMeans(fipl_matrix),decreasing = T)[1:nb_sp]
...
points(log10(colMeans(fipl_matrix[grep("T1",rownames(fipl_matrix)),names(mean_density)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T1"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T1"],lty=2)
points(log10(colMeans(fipl_matrix[grep("T2",rownames(fipl_matrix)),names(mean_density)])),type="b",pch=colList$tempo$pch[colList$tempo$cd_tempo=="T2"],bg=colList$tempo$color[colList$tempo$cd_tempo=="T2"],lty=2)
...
axis(side=2,at=c(0,log10(ATX)[2:length(ATX)]),labels=ifelse(show,ATX,NA),las=2)
text(x=(1:nb_sp)+.2,y=-.25,names(mean_density),xpd=NA,srt=45,adj=1.1)
points(1:nb_sp,log10(colMeans(fipl_matrix[zona=="Caracterización",names(mean_density)])),type="b",pch=colList$zonas$pch[colList$zonas$platform=="Caracterización"],bg=colList$zonas$color[colList$zonas$platform=="Caracterización"],lty=2,col=colList$zonas$color[colList$zonas$platform=="Caracterización"])
points(1:nb_sp,log10(colMeans(fipl_matrix[zona=="Kalé",names(mean_density)])),type="b",pch=colList$zonas$pch[colList$zonas$platform=="Kalé"], bg=colList$zonas$color[colList$zonas$platform=="Kalé"], lty=2, col=colList$zonas$color[colList$zonas$platform=="Kalé"])
points(1:nb_sp,log10(colMeans(fipl_matrix[zona=="Platero",names(mean_density)])),type="b",pch=colList$zonas$pch[colList$zonas$platform=="Platero"],bg=colList$zonas$color[colList$zonas$platform=="Platero"],lty=2,col=colList$zonas$color[colList$zonas$platform=="Platero"])
...
mean_density <- sort(colMeans(fipl_matrix),decreasing = T)[1:nb_sp]
p_mean_densities_tipCuerAg <- by(data=fipl_matrix,INDICES = tipCuerAg, FUN = function(x,c)colMeans(x[,c]),c=names(mean_density))
...
nb_sp<-15
par(mar = c(7.1,6.5,1,1))
mean_density <- sort(colMeans(fipl_matrix[tipCuerAg=="Caño",]),decreasing = T)[1:nb_sp]
p_mean_densities_tempo <- by(data=fipl_matrix[tipCuerAg=="Caño",],INDICES = tempo[tipCuerAg=="Caño"], FUN = function(x,c)colMeans(x[,c]),c=names(mean_density))
...
nb_sp<-15
par(mar = c(7.1,6.5,1,1))
mean_density <- sort(colMeans(fipl_matrix[tipCuerAg=="Ciénaga",]),decreasing = T)[1:nb_sp]
p_mean_densities_tempo <- by(data=fipl_matrix[tipCuerAg=="Ciénaga",],INDICES = tempo[tipCuerAg=="Ciénaga"], FUN = function(x,c)colMeans(x[,c]),c=names(mean_density))
mean_densities_tempo <- Reduce(rbind,p_mean_densities_tempo,)
rownames(mean_densities_tempo) <- names(p_mean_densities_tempo)[!sapply(p_mean_densities_tempo,is.null)]
plot(1:nb_sp,log10(mean_density),ylab="Densidad promedia", xlab=NA,ylim=c(0,max(log10(rbind(mean_density,mean_densities_tempo)))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
...
mean_density <- sort(colMeans(fipl_matrix[tipCuerAg=="Quebrada",]),decreasing = T)[1:nb_sp]
p_mean_densities_tempo <- by(data=fipl_matrix[tipCuerAg=="Quebrada",],INDICES = tempo[tipCuerAg=="Quebrada"], FUN = function(x,c)colMeans(x[,c]),c=names(mean_density))
mean_densities_tempo <- Reduce(rbind,p_mean_densities_tempo,)
rownames(mean_densities_tempo) <- names(p_mean_densities_tempo)[!sapply(p_mean_densities_tempo,is.null)]
plot(1:nb_sp,log10(mean_density),ylab="Densidad promedia", xlab=NA,ylim=c(0,max(log10(rbind(mean_density,mean_densities_tempo)))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
...
nb_sp<-15
par(mar = c(7.1,6.5,1,1))
mean_density <- sort(colMeans(fipl_matrix[tipCuerAg=="Río",]),decreasing = T)[1:nb_sp]
p_mean_densities_tempo <- by(data=fipl_matrix[tipCuerAg=="Río",],INDICES = tempo[tipCuerAg=="Río"], FUN = function(x,c)colMeans(x[,c]),c=names(mean_density))
mean_densities_tempo <- Reduce(rbind,p_mean_densities_tempo,)
rownames(mean_densities_tempo) <- names(p_mean_densities_tempo)[!sapply(p_mean_densities_tempo,is.null)]
plot(1:nb_sp,log10(mean_density),ylab="Densidad promedia", xlab=NA,ylim=c(0,max(log10(rbind(mean_density,mean_densities_tempo)))*1.1),pch=15,bty="n",xaxt="n",yaxt="n", las=2,type="b",lty=3)
...
**Ademas, probablemente debido a las diferencias tan grandes entre las densidades más fuertes y las más pequeñas, la distancia de Bray-Curtis da resultados ilogicos... Utilizarémos la distancia de Manhattan**
