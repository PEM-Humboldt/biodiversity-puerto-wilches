...
iNEXT_tot <- iNEXT(sort(colSums(zopl_matrix),decreasing=T),datatype ="abundance")
...
```{r}
zopl_matrix <- import_zopl$zopl_matrix*1000
rango_densidad<- list()
```
...
rango_densidad$total_tempo <- rankAbundance(zopl_matrix,type="density",extraLines = tempo,extraPch = colList$tempo$pch, extraCol = colList$tempo$color,legendTitle = "Temporada",legendOut = T, MARG=c(7,5.5,1,8),posAxisX = -0.06,labY="densidad promedia (ind/m3)",byTICK = 2000,byLABELS=4000,posNameSp=-.1)
```
...
rango_densidad$total_zona <- rankAbundance(zopl_matrix,type="density",extraLines = zona,extraPch = colList$zonas$pch, extraCol = colList$zonas$color,legendTitle = "Zonas",legendOut = T, MARG=c(6.5,5.5,1,8),posAxisX = -0.06,labY="densidad promedia (ind/m3)",byTICK = 2000,byLABELS=4000, posNameSp=-.1)
```
...
rango_densidad$total_tipCuerAg <- rankAbundance(zopl_matrix,type="density",extraLines = tipCuerAg, extraCol = colList$aquatic_habitats$color,legendTitle = "Tipos de cuerpo de agua",legendOut = T, MARG=c(8,5.5,1,8),posAxisX = -0.06,labY="densidad promedia (ind/m3)               ",byTICK = 25000,byLABELS=50000,posNameSp = -.1)
```
...
mat <- zopl_matrix[tipCuerAg=="Caño",]
mat <- mat[,as.logical(colSums(mat))]
rango_densidad$caño_tempo <- rankAbundance(mat,type="density",extraLines = tempo[tipCuerAg=="Caño"],extraPch = colList$tempo$pch, extraCol = colList$tempo$color,legendTitle = "Temporada",legendOut = T, MARG=c(6.5,5.5,1,8),posAxisX = -0.06,labY="densidad promedia (ind/m3)",byTICK = 2000,byLABELS=4000,posNameSp=-.1)
```
...
mat <- zopl_matrix[tipCuerAg=="Ciénaga",]
mat <- mat[,as.logical(colSums(mat))]
rango_densidad$caño_tempo <- rankAbundance(mat,type="density",extraLines = tempo[tipCuerAg=="Ciénaga"],extraPch = colList$tempo$pch, extraCol = colList$tempo$color,legendTitle = "Temporada",legendOut = T, MARG=c(6.5,5.5,1,8),posAxisX = -0.06,labY="densidad promedia (ind/m3)",byTICK = 5000,byLABELS=10000,posNameSp=-.1)
```
...
mat <- zopl_matrix[tipCuerAg=="Quebrada",]
mat <- mat[,as.logical(colSums(mat))]
rango_densidad$quebrada_tempo <- rankAbundance(mat,type="density",extraLines = tempo[tipCuerAg=="Quebrada"],extraPch = colList$tempo$pch, extraCol = colList$tempo$color,legendTitle = "Temporada",legendOut = T, MARG=c(7.5,6.5,1,8),posAxisX = -0.09,labY="densidad promedia (ind/m3)",byTICK = 1000,byLABELS=2000,posNameSp=-.1)
```
...
El Río parecen haber sido muestreado solo en una temporada (aguas altas)
...
mat <- zopl_matrix[tipCuerAg=="Río",]
mat <- mat[,as.logical(colSums(mat))]
rango_densidad$rio_tempo <- rankAbundance(mat,nbSp=7,type="density",legendOut = T, MARG=c(7.5,6.5,1,8),posAxisX = -0.09,labY="densidad promedia (ind/m3)",byTICK = 50,byLABELS=100,posNameSp=-.1,addProfiles = T)
```
...
save_in_excel("zopl_dataRangoDensidad.xlsx",rango_densidad)
```
